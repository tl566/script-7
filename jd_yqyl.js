...
[task_local]
#邀请有礼
5 11 * * * https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_yqyl.js, tag=邀请有礼, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "5 11 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_yqyl.js,tag=邀请有礼
=================================Surge================================
邀请有礼 = type=cron,cronexp="5 11 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_yqyl.js
====================================小火箭=============================
邀请有礼 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_yqyl.js, cronexpr="08 11 * * *", timeout=3600, enable=true
 */
const $ = new Env('邀请有礼');
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            if(helpAuthorFlag){
                try{
                    helpAuthorInfo = ['0OC2g5iHa6Yhb/EdQM6DOg=='];
                }catch (e) {}
                if(!helpAuthorInfo){
                    helpAuthorInfo = [];
                }
