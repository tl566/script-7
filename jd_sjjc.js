...
[task_local]
#手机竞猜
0 0 * * * jd_sjjc.js, tag= 手机竞猜
================Loon==============
[Script]
cron "0 0 * * *" script-path= jd_sjjc.js,tag= 手机竞猜
===============Surge=================
手机竞猜 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path= jd_sjjc.js
============小火箭=========
sjjc = type=cron,script-path= jd_sjjc.js, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
const Ariszy = '手机竞猜'
const $ = Env(Ariszy)
