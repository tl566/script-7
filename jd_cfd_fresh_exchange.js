...
更新时间：2021-11-19
活动入口：微信京喜-我的-京喜财富岛
变量  可选值  5 10 20 30 50 100 (默认5,100太难)
export JD_CFD_FRESH_DDW_VIRHB="5"
已支持IOS双京东账号,Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
============Quantumultx===============
[task_local]
#京喜财富岛合成生鲜兑换
0 0,12 * * * jd_cfd_fresh_exchange.js, tag=京喜财富岛合成生鲜兑换, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
...
===============Surge=================
京喜财富岛合成生鲜兑换 = type=cron,cronexp="0 12 * * *",wake-system=1,timeout=3600,script-path=jd_cfd_fresh_exchange.js

============小火箭=========
京喜财富岛合成生鲜兑换 = type=cron,script-path=jd_cfd_fresh_exchange.js, cronexpr="0 12 * * *", timeout=3600, enable=true
 */
