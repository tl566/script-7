...
async function getMyReward() {
  return new Promise((resolve) => {
    let options = {
      "url": `https://draw.jdfcloud.com/common/api/bean/activity/myReward?itemsPerPage=20&currentPage=1&sendType=0&appId=wxccb5c536b0ecd1bf&invokeKey=qRKHmL4sna8ZOP9F`,
      "headers": {
        'content-type': `application/json`,
        'Connection': `keep-alive`,
        'Accept-Encoding': `gzip,compress,br,deflate`,
