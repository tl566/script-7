...
async function writeFile() {
    ...
    await fs.writeFileSync(`./shareCodes/pigPet.json`, JSON.stringify($.shareCodes));
            ...
            if (data.resultCode === 0) {
              if (data.resultData.resultCode === 0) {
                if (data.resultData.resultData) {
                  ...
                  console.log(`\n【京东账号${$.index}】${$.nickName || $.UserName} 的大转盘助力码为：${data.resultData.resultData.helpId}\n`);
