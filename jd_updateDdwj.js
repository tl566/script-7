...
cookie = ''
$.shareCodes = []
var list2tokenArr = [],list2tokenArr = [],listtokenArr = [],list0tokenArr = []
...
async function writeFile() {
    ...
    await fs.writeFileSync(`./shareCodes/ddwj.json`, JSON.stringify($.shareCodes));
    console.log(`\n文件写入成功,inviteCode已经替换`);
  }
