...
[task_local]
#京东签到翻牌
10 8 * * * jd_sign_flop.js, tag=京东签到翻牌, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "10 8 * * *" script-path=jd_sign_flop.js,tag=京东签到翻牌

===============Surge=================
京东签到翻牌 = type=cron,cronexp="10 8 * * *",wake-system=1,timeout=3600,script-path=jd_sign_flop.js

============小火箭=========
京东签到翻牌 = type=cron,script-path=jd_sign_flop.js, cronexpr="10 8 * * *", timeout=3600, enable=true
*/
