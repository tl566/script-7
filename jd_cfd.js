/*
 ...
 cron 18 0,6-23/2 * * * https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_cfd.js 京喜财富岛
...
if ($.isNode() && process.env.cfd_serviceNum) {
    serviceNum = Number(process.env.cfd_serviceNum);
}
...
!(async () => {
    if (!cookiesArr[0]) {
        $.msg('【京东账号一】京喜财富岛运行失败', '【提示】请先获取京东账号一cookie\n直接使用NobyDa的京东签到获取', 'https://bean.m.jd.com/bean/signIndex.action', { "open-url": "https://bean.m.jd.com/bean/signIndex.action" });
        return
    }
    console.log(`\n 京喜财富岛开始！`)
    await requestAlgo();
